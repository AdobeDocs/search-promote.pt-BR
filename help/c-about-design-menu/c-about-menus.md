...
## Uso dos menus {#concept_68123CE5CF4447B59217B5D721424E32}

Adicione menus que mapeiam para configurações em sua pesquisa. Cada item de um menu especifica o valor para a configuração desse menu. Você também pode personalizar os rótulos dos menus.

No modelo de apresentação, é possível fazer referência aos menus definidos. Em seguida, você pode colocá-los em qualquer componente HTML que desejar, como um controle de seleção. Essa combinação permite que os usuários personalizem seus resultados de pesquisa. Há suporte para três tipos de menu: classificar, contar e navegação.
...
>[!NOTE]
>
>Certifique-se de fazer referência ao menu no modelo de apresentação para que fique visível no site.
...
1. Na página [!DNL Add Menu], defina as opções desejadas.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <li id="li_D81876660A8B48AFB70D3317063FBF6F"> <span class="uicontrol"> Classificar  </span> <p>Organiza a pesquisa por qualquer um dos tipos de metadados definidos. </p> <p>Por exemplo, você pode definir um menu de classificação com os seguintes tipos de metadados: três elementos pertinentes; um campo de metadados personalizado, como um código de disponibilidade; e preço. Os três itens podem receber os rótulos "Classificar por relevância", "Classificar por disponibilidade" e "Classificar por preço", respectivamente. Ao incluir isso no modelo de apresentação, o cliente pode usar esse controle para classificar os resultados da pesquisa. </p> </li> 
      <li id="li_63AE06B544B64DCAA8C55031B3DFFFF7"> <span class="uicontrol"> Contagem </span> <p>Define o número de resultados de pesquisa a serem mostrados. Esse tipo de menu mapeia para o parâmetro cgi <span class="varname"> sp_c </span>. </p> <p>Consulte <a href="../c-appendices/c-cgiparameters.md#reference_582E85C3886740C98FE88CA9DF7918E8" format="dita" scope="local"> Parâmetros CGI de pesquisa de backend </a>. </p> </li> 
      <li id="li_EEC810D420FF41498ECE49EBAAB33BE5"> <span class="uicontrol"> Navegação </span> <p>Especifica um conjunto de URLs estáticas associadas a itens de menu. Normalmente, um menu de navegação é usado para criar uma barra de navegação de nível superior na página de resultados de pesquisa. </p> <p>Por exemplo, você pode criar um menu que tenha mulheres, homens, meninos e meninas, onde os itens de menu seriam algo como o seguinte: 
      <code>
        /?q1=womens;x1=gender 
      </code>, 
      <code>
      ...
      <td colname="col2"> <p>O valor do item depende do tipo de menu definido. </p> 
        ...
        <li id="li_5017EC6E4ACB4B8E99E0AA61CBAAFFAE"> Tipo de menu Classificar <p>Identifica por que o item selecionado no menu deve ser classificado. Os itens selecionados são preenchidos com campos de metadados classificáveis. </p> <p>Para um único item, você pode classificar por três campos de metadados. A classificação é feita na ordem especificada. </p> </li> 
      ...
      <td colname="col2"> <p>O rótulo do item depende do tipo de menu definido. </p> 
        ...
        <li id="li_03FB2E2C96134A2B8E08154F87F0CD55"> Tipo de menu Classificar <p>Identifica o rótulo personalizado que você deseja que o cliente veja ao visualizar este item no menu. </p> </li> 
        <li id="li_C9FE2BC46D9443FB85FEB837C7CA45E1"> Tipo de menu Contagem <p>Identifica o rótulo personalizado que deseja exibir para este item de menu. </p> </li> 
        </ul> </td> 
      </tr> 
    </tbody> 
    </table>
...
1. (Opcional) Na página [!DNL Menus] , execute um dos seguintes procedimentos:
...
É possível editar as configurações de qualquer menu adicionado.
...
É possível excluir qualquer menu adicionado.
