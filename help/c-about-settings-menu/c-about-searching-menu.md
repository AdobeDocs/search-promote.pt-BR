...
Para excluir frases usadas com frequência e palavras comuns dos resultados da pesquisa, consulte [Configuração de palavras excluídas](../c-about-linguistics-menu/c-about-excluded-words.md#task_60BF6BB7A66C48479D2BBB32C0F38CDE).
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Exemplo: 
     <code>
       our free product 
     </code> </p> <p>Query de várias palavras retornam resultados mais refinados do que query de uma única palavra. </p> <p>Por exemplo, 
     <code>
       our free product 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Exemplo: 
     ...
     </code> </p> <p>Coloque os substantivos corretos em maiúsculas. Se você usar uma palavra em minúsculas, o mecanismo de pesquisa corresponderá a qualquer caso da palavra. </p> <p>Por exemplo, se você digitar 
     <code>
       search 
     </code>, o mecanismo de pesquisa retorna todos os documentos que contêm as palavras "pesquisar", "Pesquisar" e "PESQUISAR". No entanto, se você digitar 
     <code>
       Search 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Exemplos: </p> <p> 
     ...
     </ul> </p> <p>Pesquisas curingas expandem o número de correspondências para uma solicitação específica. O caractere * é usado como caractere curinga. </p> <p>Por exemplo, pesquisar por 
     <code>
       wh* 
     ...
     <code>
       +wh* -se*ch 
     </code> localiza todas as páginas que têm uma palavra que start com "wh" e não contém uma palavra que start com "se" e termina com "ch". </p> <p>A pesquisa 
     <code>
       "wh* are" 
     </code> encontra as frases "where are", "what are", "why are" e assim por diante. </p> </td> 
  </tr> 
 </tbody> 
</table>

## Adicionando uma nova definição de pesquisa {#task_98D3A168AB5D4F30A1ADB6E0D48AB648}

Você pode usar o painel [!DNL GS Add Search] para configurar e adicionar uma nova definição de pesquisa para seus componentes de Pesquisa guiada, como facetas, navegações estruturais, navegação de página, menus e pesquisas recentes, na camada de apresentação.
...
1. Na página **[!UICONTROL GS Add Search]**, defina as opções desejadas.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p>Permite que você selecione a pesquisa de back-end que deseja usar. Você pode selecionar entre <span class="wintitle"> SiteSearch </span> ou <span class="wintitle"> Comercialização </span>. </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>Essa opção só estará disponível se você escolher <span class="uicontrol"> Comercialização </span> como sua fonte. </p> <p>Especifica o nome completo do servidor <span class="wintitle"> Merchandising </span> que a pesquisa <span class="wintitle"> Merchandising </span> deve acessar. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>Porta do servidor </p> </td> 
      <td colname="col2"> <p>Essa opção só estará disponível se você escolher <span class="uicontrol"> Comercialização </span> como sua fonte. </p> <p>Especifica o número da porta do servidor <span class="wintitle"> Merchandising </span>. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>Pirâmide </p> </td> 
      <td colname="col2"> <p>Essa opção só estará disponível se você escolher <span class="uicontrol"> Comercialização </span> como sua fonte. </p> <p>Especifica a pirâmide no servidor <span class="wintitle"> Merchandising </span>. </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>Essa opção só estará disponível se você escolher <span class="uicontrol"> Search &amp; Promote </span> como sua fonte e selecionar <span class="uicontrol"> Promosearch </span>. </p> <p>Especifica que outra pesquisa por uma promoção ocorre se a pesquisa inicial por uma promoção não encontrar nada. A segunda pesquisa por uma promoção ignora a palavra-chave. Em vez disso, ele procura qualquer promoção em que um campo de metadados "is_default" esteja definido como "yes". </p> </td> 
      </tr> 
      <tr> 
...
1. (Opcional) Na página [!DNL Searches], execute um dos procedimentos a seguir:
...
## Regras de pesquisa de palavras-chave para seguir {#section_ED67A24BE884468286F34FA5DFF826D7}
...
Quando você pesquisa uma palavra-chave no painel [!DNL Stage Add New Keyword] ou no painel [!DNL Staged Edit Keyword], os resultados da pesquisa refletem o que pode acontecer após a próxima operação de índice. Você pode reordenar os resultados da pesquisa na tabela usando um dos três métodos diferentes.

O primeiro método é usar a caixa de seleção **[!UICONTROL Pinned]**. A caixa de seleção é usada para fixar um resultado a uma posição específica. Quando você seleciona a caixa de seleção, todos os resultados da pesquisa acima da caixa de seleção também são fixados. Essa funcionalidade garante que todos os resultados acima dessa caixa de seleção sejam exibidos nessa ordem específica. Desvincular um resultado de pesquisa faz com que ele caia abaixo de todos os resultados atualmente fixados.
...
O terceiro método é definir a ordem dos resultados fixados digitando uma posição específica na coluna &quot;#&quot;. Ao contrário do recurso arrastar e soltar, a ordem dos resultados de pesquisa simulados só será óbvia na próxima vez que você abrir o painel [!DNL Staged Edit Keyword]. A definição do número do pedido para uma linha atualmente não fixada garante que pelo menos muitos itens sejam fixados. A definição do número do pedido para uma linha atualmente fixada define a ordem desse item dentro dos itens atualmente fixados. No entanto, não aumenta o número de itens fixados.
...
1. Na página [!DNL Add New Keyword], no campo **[!UICONTROL Keyword]**, digite um query de pesquisa e clique em **[!UICONTROL Search Keyword]**.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p>Identifica o nome do cabeçalho da coluna que aparece na tabela <span class="wintitle"> Resultados de pesquisa simulados </span> do painel <span class="wintitle"> Adicionar nova palavra-chave preparada </span> e do painel <span class="wintitle"> Editar palavra-chave preparada </span>. </p> </td> 
      </tr> 
      <tr> 
...
1. (Opcional) Execute um dos procedimentos a seguir:
   ...
   * Clique em **[!UICONTROL Edit Table]** para ajustar a visualização da tabela [!DNL Simulated Search Results]. Quando terminar, clique em **[!UICONTROL Save Changes]** para retornar ao painel [!DNL Add New Keyword].
...
1. (Opcional) Na página [!DNL Pinned Results Keyword Manager], execute um dos procedimentos a seguir:
...
1. Na página [!DNL Edit Keyword], no campo **[!UICONTROL Keyword]**, digite um query de pesquisa e clique em **[!UICONTROL Search Keyword]**.
...
1. (Opcional) Execute um dos procedimentos a seguir:
   ...
   * Reordene os resultados da pesquisa.
   * Clique em **[!UICONTROL Edit Table]** para ajustar a visualização da tabela [!DNL Simulated Search Results].
...
1. No menu do produto, clique em **[!UICONTROL Settings]** > **[!UICONTROL Searching]** > **[!UICONTROL Pinned Results]**.
1. Na página [!DNL Pinned Keyword Results Manager], na tabela, clique em **[!UICONTROL Delete]** na linha da palavra-chave que você deseja remover.
...
1. (Opcional) Reconstrua o índice do site preparado se desejar pré-visualização nos resultados.
   ...
   Consulte [Configurar um índice incremental de um site preparado](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0).
1. (Opcional) Na página [!DNL Collections], execute um dos procedimentos a seguir:
...
## Adicionando restrições de máscara de URL de quem indicou ou de endereço IP {#task_E6FF2DD83E8D4B00A0E2809DC13A56C9}
...
1. Na página [!DNL Restrictions], defina as opções de restrição desejadas. Insira endereços de máscara de URL de quem indicou, endereços de máscara de endereço IP ou, opcionalmente, um endereço de URL de uma página da Web personalizada que é exibida para clientes que não têm permissão para pesquisar no site.
...
## Sobre a Pré-visualização {#concept_DF293FD3B02C467F8842C8C21D62F294}

A string de query e os parâmetros definidos em [!DNL Preview] são usados sempre que um formulário de pesquisa é testado ou visualizado no software.
...
1. Dependendo do tipo de feed selecionado, na caixa de diálogo [!DNL Create Feed], defina as opções como identificadas em cada painel do assistente.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col3"> <p>Quando você chega ao painel <span class="wintitle"> Verificação </span>, seu feed é salvo nesse ponto. No entanto, os arquivos de feed reais não são salvos até mais tarde. </p> <p>O painel <span class="wintitle"> Verificação </span> permite fazer o seguinte: </p> 
        ...
        <li id="li_07FC9F04C7F640048546F9DC5D91DA1D"> <span class="uicontrol"> Visualização de dados  </span> <p>Permite que você clique no link para verificar a saída do feed por meio de uma visualização de dados exibida em forma de tabela. A visualização de dados também pode ajudá-lo a solucionar problemas, mostrando quais campos meta são escolhidos e como qualquer critério de pesquisa especificado no painel <span class="wintitle"> Critérios de pesquisa </span> no assistente afeta a saída do feed. A visualização de dados é gerada dinamicamente, de modo que esteja disponível o tempo todo. </p> </li> 
    ...
    <tbody> 
      ...
      <td colname="col3"> <p>Permite configurar o agendamento para enviar os arquivos de feed e definir o método que deseja usar para fazer upload dos arquivos. </p> 
        ...
        <li id="li_2D9ECAFB8E8544D39B486F7BC3DCE589"> <span class="uicontrol"> Método de upload  </span> <p>A maioria dos feeds tem duas formas de distribuir os arquivos: FTP e Rede de conteúdo hospedado. </p> <p>O método de upload recomendado para enviar o feed de dados é <span class="uicontrol"> FTP </span>. O Google Merchant Center hospeda um servidor FTP para esse fim. Consulte a Ajuda do Google Merchant Center sobre como configurar uma conta FTP separada do Google para este feed do Google Product Search. </p> 
          ...
          <li id="li_DB28CA23C94A4AF09E1A0EB06DF8F40C"> <span class="uicontrol"> FTP  </span> <p>Os servidores de pesquisa/comercialização do site usam FTP passivo. </p> <p>O FTP é a única maneira de enviar um arquivo para outro servidor. </p> <p> <span class="uicontrol"> Servidor FTP  </span> - Especifica o nome do servidor FTP. Neste caso, é 
            <code>
              uploads.google.com 
...
* Na página [!DNL Feeds], na coluna [!DNL Name], clique no nome de um feed que você deseja alterar.
...
## Exibindo arquivos de feed {#task_1E413C7650DE466EA68925F72E086884}
...
## Gerando e fazendo upload de um feed {#task_C9A57827C7674035B62A22D310DDAA0C}

Você pode gerar e enviar arquivos de feed manualmente para o destino final, independentemente do agendamento definido no painel [!DNL File Submission] do assistente de feed.
