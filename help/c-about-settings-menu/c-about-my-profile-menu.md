---
description: Use o menu Meu perfil para definir informações pessoais, preferências, senha de login e privilégios de acesso de exibição.
seo-description: Use o menu Meu perfil para definir informações pessoais, preferências, senha de login e privilégios de acesso de exibição.
...
Use o menu Meu perfil para definir informações pessoais, preferências, senha de login e privilégios de acesso de exibição.

## Configurar suas informações pessoais de usuário {#task_A11A3BE2527B4204B896E04303B04AA6}

Você pode exibir e gerenciar as informações pessoais do usuário associadas à sua conta, incluindo a configuração do endereço de email necessário e a codificação de caracteres usada pela maioria das páginas do site.
...
Quando você especifica o endereço de email, ele deve conter somente caracteres ASCII. Usar alfabético padrão (a..z) caracteres ou `(0..9)` caracteres numéricos com exatamente um `@` caractere usado para separar o nome do usuário do domínio. Também são permitidos os caracteres `_`, `+`, `-`, `.`, `!`, `#`, `$`, `'`, `%`, `&``*``=``?``^``{``}` ,,,,, e . Seu endereço de email não pode começar com um caractere ponto (`.`).
...
Consulte [Visualizar seus privilégios](../c-about-settings-menu/c-about-my-profile-menu.md#task_6107C5BA333B4053A56325AE5E3A1848)de acesso.
...
1. Na [!DNL Personal Information] página, especifique os campos desejados.

   Somente o [!DNL Email Address] campo é obrigatório.
...
1. Na [!DNL My Preferences] página, defina os campos desejados.
   ...
   | Validar atributos de tag do modelo ao salvar | Valida todos os atributos em &lt;guided-*> e &lt;search-*> quando você salva um modelo no Editor de modelos.  Consulte [Editar uma apresentação ou um modelo](../c-about-design-menu/c-about-templates.md#task_800E0E2265C34C028C92FEB5A1243EC3)de transporte. |
...
## Alteração da senha de login {#task_F5FF13AAD1514FE997C8882D4537C0C9}

Você pode alterar a senha que usa para fazer logon. A primeira vez que os usuários recebem uma senha automaticamente.

Se você perder ou esquecer sua senha, clique **[!UICONTROL Forgot your password?]** na página de logon e siga as instruções para gerar uma nova senha.
...
1. Na [!DNL Change Password] página, no [!DNL Current Password] campo, digite a senha de login atual que você usa.
1. No [!DNL New Password] campo e no [!DNL New Password (again)] campo, digite a nova senha de logon que você deseja usar.
1. Clique em **Salvar alterações**.

## Cancelando seu logon {#task_D57701BB726243B08CEA14EEC86C3087}

Você pode optar por cancelar seu logon da Adobe. Se cancelar seu logon, você não poderá acessar essa conta ou qualquer outra conta da Adobe com o email de login exibido.
...
1. Na [!DNL Cancel Login] página, clique em **[!UICONTROL Cancel Login]**.
1. Clique em **[!UICONTROL Yes]** para confirmar o cancelamento.

## Exibir seus privilégios de acesso {#task_6107C5BA333B4053A56325AE5E3A1848}
...
O privilégio **[!UICONTROL Can push live]** na exibição em árvore é um controle especial que concede a qualquer usuário nessa função a capacidade de colocar qualquer item preparado ao vivo. Ao criar uma função que não tenha essa capacidade, você pode garantir que os usuários nessa função não possam afetar sua pesquisa ao vivo até que alguém com a capacidade de mover as configurações em tempo real revise seu trabalho e faça isso.
...
**Para exibir seus privilégios de acesso**

1. No menu do produto, clique em **[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL My Access Privileges]**.
1. Na [!DNL My Access Privileges] página, expanda as visualizações em árvore para revisar privilégios ou acesso restrito.
